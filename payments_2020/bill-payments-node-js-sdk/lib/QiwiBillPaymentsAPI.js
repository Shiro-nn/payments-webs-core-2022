...
module.exports = class QiwiBillPaymentsAPI {
    ...
    async balance() {
        const headers = {
            'Content-Type': 'application/json;charset=UTF-8',
            Accept: 'application/json',
            Authorization: `Bearer ${config.qiwiapi}`
        };

        const options = {
            uri: `https://edge.qiwi.com/funding-sources/v2/persons//accounts`,
            method: 'GET',
            headers,
            json: true
        };
    ...
    createPaymentForm (params) {
        ...
        return `${url}?${query.toString()}&customFields%5BthemeCode%5D=Artur-VzQ5-ezzo6`;
    }
