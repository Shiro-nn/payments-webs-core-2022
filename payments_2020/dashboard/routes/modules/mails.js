...
HM.psucEmail = function(namelink, name)
{
	const html = `
	<!doctype html>
      ...
      <table align='center' background='http://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:url(http://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg) top center / auto repeat;width:100%;'>
        <tbody>
          <tr>
            <td>
              <!--[if mso | IE]>
<v:rect style="mso-width-percent:1000;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill src="http://s3.amazonaws.com/swu-filepicker/4E687TRe69Ld95IDWyEg_bg_top_02.jpg" origin="0.5, 0" position="0.5, 0" type="tile" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
<![endif]-->
                                            ...
                                            <tr>
                                              <td align='left'>
                                                <a href='https://fydne.xyz'>
                                                  <img align='left' alt height='33' padding='5px' src='https://bot.fydne.xyz/fydnelogo.png' width='120' alt="img" />
                                                </a>
                                              </td>
                                              <td align='right' style='vertical-align:bottom;' width='34px'>
                                                <a href='https://bot.fydne.xyz'>
                                                  <img alt='bot' height='22' src='https://bot.fydne.xyz/fydne.png' width='22' />
                                                </a>
                                              </td>
                                              <td align='right' style='vertical-align:bottom;' width='34px'>
                                                <a href='https://bot2.fydne.xyz'>
                                                  <img alt='bot' height='22' src='https://fydne.xyz/img/anime.png' width='22' />
                                                </a>
                                              </td>
                                              <td align='right' style='vertical-align:bottom;' width='34px'>
                                                <a href='https://scpsl.fydne.xyz'>
                                                  <img alt='scpsl' height='22' src='https://media.discordapp.net/attachments/676095371147214878/731599560643707000/avatar.png' width='22' />
                                                </a>
                                              </td>
                                            </tr>
                                          </table>
                                  ...
                                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='' width='100%'>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                        <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                          <a style='display:block; color: #ff6f6f; font-weight: bold; text-decoration: none;'>
										  Доброго времени суток
										  </a>
										  <br>
                      <span>
										  Вы успешно оплатили товар на сайте <a href='https://${namelink}' style="color: cyan; cursor: url(https://bot.fydne.xyz/cursors/cyan/pointer.cur), pointer !important;">${name}</a>
                                          </span>
                                        </div>
                                      </td>
                                    </tr>
...
HM.composeEmail = function(o)
{
	let baseurl = process.env.NL_SITE_URL || 'https://payments.fydne.xyz';
	const html = `
	<!doctype html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
                                        ...
                                        <td align='left' style='font-size:0px;padding:0px;word-break:break-word;'>
                                          <table border='0' cellpadding='0' cellspacing='0' style='cellpadding:0;cellspacing:0;color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;' width='100%'>
                                            <tr>
                                              <td align='left'>
                                                <a href='https://fydne.xyz'>
                                                  <img align='left' alt height='33' padding='5px' src='https://bot.fydne.xyz/fydnelogo.png' width='120' />
                                                </a>
                                              </td>
                                              <td align='right' style='vertical-align:bottom;' width='34px'>
                                                <a href='https://bot.fydne.xyz'>
                                ...
                                <td style='background-color:#ffffff;border:1px solid #ccc;padding:45px 75px;vertical-align:top;'>
                                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='' width='100%'>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                        <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                          <a style='display:block; color: #ff6f6f; font-weight: bold; text-decoration: none;'>
										  Доброго времени суток, <b>${o.user}</b>
										  </a>
										  <br>
                                          <span>
										  Кто-то запросил сброс вашего пароля, если это вы, то перейдите по <a href='${baseurl}/reset-password?key=${o.passKey}' style="color: cyan; cursor: url(https://bot.fydne.xyz/cursors/cyan/pointer.cur), pointer !important;">ссылке</a>
                                          </span>
                                        </div>
                                      </td>
                                    </tr>
                                  ...
                                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='' width='100%'>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                        <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
										  ...
										  <br>
                                          <span>
                                          Вы успешно зарегистрировали аккаунт на сайте <a href='${baseurl}' style="color: cyan; cursor: url(https://bot.fydne.xyz/cursors/cyan/pointer.cur), pointer !important;">fydne</a>
                                          <br>
                                          Логин: <b>${o.user}</b>
                                          </span>
                                        </div>
